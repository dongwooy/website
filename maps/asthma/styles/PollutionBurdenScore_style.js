var size = 0;
var ranges_PollutionBurdenScore = [[2.007581, 4.856252, [ new ol.style.Style({
...
[4.856252, 5.464082, [ new ol.style.Style({
...
[5.464082, 5.928896, [ new ol.style.Style({
...
[5.928896, 6.238702, [ new ol.style.Style({
...
[6.238702, 6.532252, [ new ol.style.Style({
...
[6.532252, 6.756798, [ new ol.style.Style({
...
[6.756798, 7.054760, [ new ol.style.Style({
...
[7.054760, 7.410341, [ new ol.style.Style({
...
[7.410341, 7.926771, [ new ol.style.Style({
...
[7.926771, 9.703952, [ new ol.style.Style({
...
var styleCache_PollutionBurdenScore={}
var style_PollutionBurdenScore = function(feature, resolution){
    var value = feature.get("pburdensco");
    var style = ranges_PollutionBurdenScore[0][2];
    for (i = 0; i < ranges_PollutionBurdenScore.length; i++){
        var range = ranges_PollutionBurdenScore[i];
    ...
    if (!styleCache_PollutionBurdenScore[key]){
        ...
        styleCache_PollutionBurdenScore[key] = new ol.style.Style({"text": text})
    }
    var allStyles = [styleCache_PollutionBurdenScore[key]];
